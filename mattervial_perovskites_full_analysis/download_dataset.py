"""
This script downloads the featurized perovskites dataset featurized with mattervial
coGN and SISSO formulas from diverse sources.
The script downloads and extracts a .tar.gz file from the URL.
"""
import requests
import tarfile
import io
...
FILE_URL = "https://figshare.com/ndownloader/files/57965299"
# ---------------------
